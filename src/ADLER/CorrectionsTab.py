...
class CorrectionsTab(AdlerTab):
    ...
    def __init__(self, master, canvas, log, mthreads=1, startpath=None, app=None):
        ...
        self.params = [
            ...
            (energy_variables, "Energy Calibration"),
    ...
    def make_layout(self):
        ...
        button_list = [
            ...
            [
                ...
                "Create a dataset made of random numbers",
                col1,
                "Files",
            ],  # 3
            [
            ...
            [
                ...
                "Fit the curvature of the elastic line.",
                col2,
                "Processing",
            ],  # 7
            [
            ...
            [
                ...
                "Shift the pixels vertically, column per column, to eliminate the curvature.",
                col1,
                "Corrections",
            ],  # 11
            [
                "FFT Filter",
                self.fft_filter,
                'Filter out a part of the frequency spectrum of the data. AKA "Remove Stripes".',
                col1,
                "Corrections",
            ],  # 12
            [
                "Histogram of counts",
                self.core.make_histogram,
                "Plot the distribution of the pixel counts in the selected detector area.",
                col1,
                "QC",
            ],  # 13
        ]
    ...
    def show_fft(self):
        ...
        self.plotter.plot1D(
            [forplot],
            fig=self.figure,
            text="Normalised Fourier Transform plot",
            label_override=["Channels$^{-1}$", "Signal"],
            curve_labels=["Sum"],
        )
    ...
    def plot_histogram(self, seglist):
        ...
        self.plotter.plot1D(
            ...
            label_override=["Counts", "Occurences"],
            curve_labels=["detector values"],
        )
